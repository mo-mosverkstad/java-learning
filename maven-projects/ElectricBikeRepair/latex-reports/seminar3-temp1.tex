...
Constants, \texttt{final static} fields, are written in all uppercase letters, separated by underscores. For instance, the constant \texttt{BIKE\_PRINTOUT\_FORMAT} holds the format of a format string showing the detail information of a \texttt{BikeDTO}.
