...
The console output of a complete workflow run is shown, broken down by each step. The output is produced by executing the program using \texttt{mvn compile exec:java -Dexec.mainClass="se.ebikerepair.startup.Main"}.
