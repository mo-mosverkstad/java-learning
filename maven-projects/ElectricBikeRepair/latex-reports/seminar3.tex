...
This report delves into the implementation of a software system that manages electric bike repair processes in code. The code implementation are based on class diagrams in terms of structure as well as the communication diagram for each system operation in terms of functionality and behavior. Using these methods, the structure of the program can be outlined. Additionally, the program also involves

This report concerns the implementation of a software system for managing repair processes in an
electric bike workshop. The system design is based on given requirement specification
with both normal and alternative workflow scenarios.

\subsection{Requirements of Seminar 3}
Requirements \dots

\subsection{Implementing code on system operation diagrams}
System diagrams are implemented as code ...
